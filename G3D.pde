...
vec MouseDragZ() {return V(mouseX-pmouseX,0,mouseY-pmouseY);};
...
vec R90(vec V) {float z = -(V.x+V.y)/V.z; return U(V(1,1,z));} // just find a fucking vector that is orthogonal to V
